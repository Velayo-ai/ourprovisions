...
*Last updated: 2026-07-09 (deliberate-loss guard pattern — `deliberateLossRef`, watchdog defers to user-initiated household loss; removal-notice name from pre-update list; Splunk RUM session replay unmasked + rendering, masking-key + blank-player gotchas)*
